              ...
              <div className="card  shadow  rounded relative border ">
                ...
                <div className="card-body p-3 ">
                  ...
                  <div className="flex justify-between mt-4">
                    ...
                    <div
                      className=" flex justify-center items-center text-2xl cursor-pointer tooltip tooltip-info"
                      data-tip="ai tool"
                    >
                      <BsStars />
                    </div>
                  ...
                  <div className="flex space-x-2 my-4">
                    <Link
                      href="https://9432604211760.gumroad.com/l/demo"
                  ...
                  <div className=" flex overflow-hidden justify-between">
                    ...
                    <button className="btn btn-neutral border-0  no-animation bg-secondary text-2xl px-12 rounded-full">
