...
const Navbar = () => {
  ...
  return (
    <div className="border-b h-18 bg-base-100">
      <div className="navbar max-w-[1280px] mx-auto">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 text-md uppercase font-semibold">
            ...
            <li className="dropdown dropdown-hover">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content z-[1] menu p-2 shadow bg-base-100 text-md font-light w-36"
              >
                <li>
                  <a>Submit Tool</a>
                </li>
            ...
            <li className="dropdown dropdown-hover">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content z-[1] menu p-2 shadow bg-base-100 w-52 text-md font-light"
              >
                <li>
                  <a>Newsletter Issues</a>
                </li>
        ...
        <div className="navbar-end">
          ...
          {status === "unauthenticated" ? (
            <Link className="btn btn-xs ml-3" href="/login">
              Login
            </Link>
          ) : (
            <>
