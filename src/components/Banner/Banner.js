    ...
    <div className="text-center">
      ...
      <div className="lg:space-x-16 space-y-6">
        <button className="btn relative">
          ...
          <div className="badge badge-secondary badge-sm text-white absolute z-10 top-[-10px] right-[-10px]">9</div>
        </button>
        <button className="btn btn-outline btn-secondary relative">
