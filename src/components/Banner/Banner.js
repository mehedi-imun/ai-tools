  ...
  return (
    <div className="mb-12 mt-6 flex flex-col justify-center md:flex-row md:items-center space-y-6 md:space-y-0 md:space-x-6">
      <div className="text-center">
        ...
        <h1 className="text-xl md:text-2xl uppercase font-medium text-gray-600 my-3 tag_line">
        ...
        <div className="lg:space-x-16 space-y-6">
          <Link href="/recent" className="btn relative rounded-full">
            <BsTools className="text-2xl md:text-3xl "></BsTools>Today added
            tools
            <div className="badge badge-secondary badge-sm text-white absolute z-10 top-[-5px] right-[-5px]">
              9
            </div>
          </Link>
          <Link
            href="/news"
            className="btn btn-outline btn-secondary relative rounded-full"
          >
